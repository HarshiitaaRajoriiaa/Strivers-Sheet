...
public class LongestSubArrayWithK {
    public static void main(String[] args) {
        int arr[] = { 1, 2, 3, 7, 5 };
        int sum = 12;
        System.out.println(maxLengthO(arr, sum));

    }

    // *BRUTE FORCE METHOD: iterating all the possible subarrays and find the
    // maximum length of subarrays whose sum are equal to 'sum'
    // ! TC =0(N*N)
