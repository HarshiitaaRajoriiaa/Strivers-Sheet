...
public class SubArrayWithSumK {
    ...
    // *OPTIMIZED APPROACH: Perefix sum array approach/ reversed Mathematics if any sub array has sum = x , and if any sub array has sum {left !=0} is K, then there will any point sub array {0 to i} where sum = x-K from that point we will consider array from.
